...
public class LifestyleAssessmentServiceImpl implements LifestyleAssessmentService {
    ...
    private final AIFeedbackRepository aiFeedbackRepository; // ADDED

    @Autowired
    public LifestyleAssessmentServiceImpl(LifestyleAssessmentRepository assessmentRepository,
                                          UserRepository userRepository,
                                          AIService aiService,
                                          AIFeedbackRepository aiFeedbackRepository) { // ADDED
        this.assessmentRepository = assessmentRepository;
        this.userRepository = userRepository;
        this.aiService = aiService;
        this.aiFeedbackRepository = aiFeedbackRepository; // ADDED
    ...
    public LifestyleAssessmentResponse createOrUpdateAssessment(LifestyleAssessmentRequest request) {
        ...
        // Generate AI feedback for new assessments asynchronously
        if (isNew && aiService != null) {
            generateAIFeedbackAsync(assessment);
        } else if (isNew) {
    ...
    @Async
    protected void generateAIFeedbackAsync(LifestyleAssessment assessment) {
        try {
            log.info("Starting async AI feedback generation for assessment: {}", assessment.getId());
            ...
            log.info("✓ Async AI feedback generation completed successfully for assessment: {}",
                    assessment.getId());
    ...
    private LifestyleAssessmentResponse mapToResponse(LifestyleAssessment assessment) {
        ...
        boolean hasAIFeedback = aiFeedbackRepository.existsByAssessmentId(assessment.getId());
